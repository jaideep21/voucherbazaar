...
export class Backend implements backendInterface {
    ...
    async createVoucher(arg0: string, arg1: string, arg2: number, arg3: number, arg4: string, arg5: string, arg6: string, arg7: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createVoucher(arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteVoucher(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async extractTextFromImage(arg0: string): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.extractTextFromImage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async extractTextTransform(arg0: TransformationInput): Promise<TransformationOutput> {
        if (this.processError) {
            try {
                const result = await this.actor.extractTextTransform(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAvailableVouchers(): Promise<Array<Voucher>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAvailableVouchers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMyVouchers(): Promise<Array<Voucher>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMyVouchers();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVouchersByCategory(arg0: string): Promise<Array<Voucher>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVouchersByCategory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
